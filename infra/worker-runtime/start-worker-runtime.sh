...
export WORKER_RUNTIME_MODE="${WORKER_RUNTIME_MODE:-hidden_runtime}"
export WORKER_RUNTIME_CLASS="${WORKER_RUNTIME_CLASS:-docker_headed_xvfb}"
export WORKER_HEADLESS="${WORKER_HEADLESS:-false}"
