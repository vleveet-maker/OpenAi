...
- Phase 26 is now planned as a narrow operational follow-up: recover repo-backed Ubuntu sync, keep the reverse-tunnel task retained, expose the latest restoration artifact in operator surfaces, and rerun authenticated external smoke from a host that actually has the bearer token
