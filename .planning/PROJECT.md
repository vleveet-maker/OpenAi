...
- Phase 27 local Waves 1-2 are now complete: the repo now carries the canonical Ubuntu-SSH recovery wrapper, the GitHub-first deployed-host prompt, and the operator-visible latest-state surface needed before the live Ubuntu plus Windows run
